...
async function main() {
    try {
        ...
        const LINTIAN_TAGS_TO_SUPPRESS = core.getInput("LINTIAN_TAGS_TO_SUPPRESS") || "odd-historical-debian-changelog-version,initial-upload-closes-no-bugs,debian-watch-file-is-missing,spelling-error-in-changelog"
